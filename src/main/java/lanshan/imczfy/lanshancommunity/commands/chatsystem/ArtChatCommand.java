...
public class ArtChatCommand extends Command {

    public ArtChatCommand() {
        super("artchat", "chat.art", new String[] {"builderchat", "buildchat", "bchat"});
    }
    ...
    private String returnMsg(CommandSender s, String msg) {
        ...
        String format = ChatColor.AQUA + "建筑/美工 §7» " + ChatColor.translateAlternateColorCodes('&', p) + s.getName() + ChatColor.GRAY + ": " + ChatColor.WHITE + msg;
        return format;
    }
}
